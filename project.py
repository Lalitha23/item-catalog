...
#FBConnect method to authorize code from client and exchanges access token
...
#GCONNECT method to authorize code from client and exchanges access token 
...
def editRestaurant(restaurant_id):
	...
	if request.method == 'POST':
		...
		session.commit()
		flash("sucessfully edited restaurant name")
		return redirect(url_for('restaurantList'))
	else:
...
def editMenuItem(restaurant_id, menu_id):
	...
	if request.method == 'POST':
		...
		session.commit()
		flash("sucessfully edited menu item")
		return redirect(url_for('restaurantMenu', restaurant_id=restaurant_id))
	else:
...
@app.route('/restaurants/<int:restaurant_id>/<int:menu_id>/delte', methods=['GET','POST'])
def deleteMenu(restaurant_id, menu_id):
	...
	if request.method == 'POST':
		...
		session.commit()
		flash("sucessfully delted menu item")
		return redirect(url_for('restaurantMenu', restaurant_id=restaurant_id))
	else:
		return render_template('deletemenu.html', item=deleteItem)
